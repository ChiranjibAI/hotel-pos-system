...
import 'package:hotel_pos_system/components/dialog/dialog_page.dart';
import 'package:hotel_pos_system/components/style/pop_button.dart';
import 'package:hotel_pos_system/constants/constant.dart';
import 'package:hotel_pos_system/debug/debug_page.dart';
import 'package:hotel_pos_system/helpers/breakpoint.dart';
...
import 'package:hotel_pos_system/ui/analysis/analysis_view.dart';
import 'package:hotel_pos_system/ui/analysis/history_page.dart';
import 'package:hotel_pos_system/ui/analysis/widgets/chart_modal.dart';
import 'package:hotel_pos_system/ui/analysis/widgets/chart_reorder.dart';
import 'package:hotel_pos_system/ui/analysis/widgets/history_order_modal.dart';
import 'package:hotel_pos_system/ui/cashier/cashier_view.dart';
import 'package:hotel_pos_system/ui/cashier/changer_modal.dart';
import 'package:hotel_pos_system/ui/cashier/surplus_page.dart';
import 'package:hotel_pos_system/ui/home/elf_page.dart';
import 'package:hotel_pos_system/ui/home/home_page.dart';
import 'package:hotel_pos_system/ui/home/mobile_more_view.dart';
import 'package:hotel_pos_system/ui/home/settings_page.dart';
import 'package:hotel_pos_system/ui/image_gallery_page.dart';
import 'package:hotel_pos_system/ui/menu/menu_page.dart';
import 'package:hotel_pos_system/ui/menu/product_page.dart';
import 'package:hotel_pos_system/ui/menu/widgets/catalog_modal.dart';
import 'package:hotel_pos_system/ui/menu/widgets/catalog_reorder.dart';
import 'package:hotel_pos_system/ui/menu/widgets/product_ingredient_modal.dart';
import 'package:hotel_pos_system/ui/menu/widgets/product_ingredient_reorder.dart';
import 'package:hotel_pos_system/ui/menu/widgets/product_modal.dart';
import 'package:hotel_pos_system/ui/menu/widgets/product_quantity_modal.dart';
import 'package:hotel_pos_system/ui/menu/widgets/product_reorder.dart';
import 'package:hotel_pos_system/ui/order/order_checkout_page.dart';
import 'package:hotel_pos_system/ui/order/order_page.dart';
import 'package:hotel_pos_system/ui/order_attr/order_attribute_page.dart';
import 'package:hotel_pos_system/ui/order_attr/widgets/order_attribute_modal.dart';
import 'package:hotel_pos_system/ui/order_attr/widgets/order_attribute_option_modal.dart';
import 'package:hotel_pos_system/ui/order_attr/widgets/order_attribute_option_reorder.dart';
import 'package:hotel_pos_system/ui/order_attr/widgets/order_attribute_reorder.dart';
import 'package:hotel_pos_system/ui/printer/printer_modal.dart';
import 'package:hotel_pos_system/ui/printer/printer_page.dart';
import 'package:hotel_pos_system/ui/printer/printer_settings_modal.dart';
import 'package:hotel_pos_system/ui/stock/quantities_page.dart';
import 'package:hotel_pos_system/ui/stock/replenishment_page.dart';
import 'package:hotel_pos_system/ui/stock/stock_view.dart';
import 'package:hotel_pos_system/ui/stock/widgets/replenishment_apply.dart';
import 'package:hotel_pos_system/ui/stock/widgets/replenishment_modal.dart';
...
class Routes {
  ...
  static final ValueNotifier<HomeMode> homeMode = ValueNotifier(.bottomNavigationBar);

  /// Get the full path of the route
  static getRoute(String path) => 'https://yourname.github.io$base/$path';
  ...
  static GoRoute _gstReportRoute({required bool inShell}) => GoRoute(
    name: gstReport,
    path: '${(inShell ? '_/' : '')}gst',
    parentNavigatorKey: inShell ? null : rootNavigatorKey,
    builder: (ctx, state) => _w(_l(const GstReportPage(), state), 'GST Report'),
  );

  static GoRoute _qrOrderingRoute({required bool inShell}) => GoRoute(
    name: qrOrdering,
    path: '${(inShell ? '_/' : '')}qr',
    parentNavigatorKey: inShell ? null : rootNavigatorKey,
    ...
    routes: [
      GoRoute(
        ...
        builder: (ctx, state) {
          ...
          final feature = Feature.values.firstWhereOrNull((e) => e.name == f) ?? .theme;
...
DateTimeRange? _parseRange(String? val) {
  try {
    ...
    return DateTimeRange(
      start: DateTime(.parse(ss[0]), .parse(ss[1]), .parse(ss[2])),
      end: DateTime(.parse(ss[3]), .parse(ss[4]), .parse(ss[5])),
    );
  } catch (e) {
    return null;
  }
...
enum HomeMode {
  ...
  bool isMobile() => this == .bottomNavigationBar;
}
