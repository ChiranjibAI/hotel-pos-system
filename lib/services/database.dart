...
import 'package:hotel_pos_system/services/database_migrations.dart';
...
class Database {
  ...
  static final String delimiter = .fromCharCode(29);
  ...
  static Future<String> getRootPath() async {
    final paths = (await XFile.getRootPath()).split(XFile.fs.path.separator)
      ..removeLast()
      ..add('databases');
    return '${paths.join('/')}/hotel_pos_system.sqlite';
  }
}
