...
class Storage {
  ...
  static Future<String> getRootPath() async {
    final paths = (await XFile.getRootPath()).split(XFile.fs.path.separator)
      ..removeLast()
      ..add('databases');
    return '${paths.join('/')}/hotel_pos_system.sembast';
  }
...
enum Stores { menu, stock, replenisher, quantities, cashier, orderAttributes, analysis, printers, tables, staff, customers, reservations, outlets }
