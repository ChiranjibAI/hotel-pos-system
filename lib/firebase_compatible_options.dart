...
class DefaultFirebaseOptions {
  static FirebaseOptions get currentPlatform {
    ...
    return switch (defaultTargetPlatform) {
      .android => isProd ? android : androidDebug,
      .iOS => isProd ? ios : iosDebug,
  ...
  static const FirebaseOptions androidDebug = FirebaseOptions(
    ...
    projectId: 'hotel-pos-system-debug',
    storageBucket: 'hotel-pos-system-debug.appspot.com',
  );
  ...
  static const FirebaseOptions iosDebug = FirebaseOptions(
    ...
    iosBundleId: 'com.hotelpos.system',
  );
