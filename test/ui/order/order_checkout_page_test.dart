...
import 'package:hotel_pos_system/components/imageable_container.dart';
...
import 'package:hotel_pos_system/models/repository/stashed_orders.dart';
        ...
        testWidgets('Order with attributes and reset period sequence', (tester) async {
          ...
          final checker = OrderSetter.setPushed(
            OrderObject(
              ...
              attributes: const [
                OrderSelectedAttributeObject(name: 'oa-2', optionName: 'oao-3', mode: .changePrice, modeValue: 10),
                OrderSelectedAttributeObject(name: 'oa-3', optionName: 'oao-5', mode: .statOnly),
              ],
            ),
          );
